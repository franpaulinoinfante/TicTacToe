...
internal class PlayView
{
    ...
    internal void Interact()
    {
        do
        {
            ...
            new MessageView(GameViews.Message.CurrentTurn).WriteLine(_game.GetCurrent().ToString());
        ...
        new MessageView(GameViews.Message.Winner).WriteLine(_game.GetCurrent().ToString());
    }
}